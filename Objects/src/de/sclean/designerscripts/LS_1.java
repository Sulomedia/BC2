...
//BA.debugLineNum = 5;BA.debugLine="prb.SetTopAndBottom(52%y,62%y)"[1/General script]
views.get("prb").vw.setTop((int)((52d / 100 * height)));
views.get("prb").vw.setHeight((int)((62d / 100 * height) - ((52d / 100 * height))));
...
//BA.debugLineNum = 10;BA.debugLine="lv1.SetTopAndBottom(28%y,40%y)"[1/General script]
views.get("lv1").vw.setTop((int)((28d / 100 * height)));
views.get("lv1").vw.setHeight((int)((40d / 100 * height) - ((28d / 100 * height))));
...
//BA.debugLineNum = 18;BA.debugLine="pb2.Right=95%x"[1/General script]
views.get("pb2").vw.setLeft((int)((95d / 100 * width) - (views.get("pb2").vw.getWidth())));
