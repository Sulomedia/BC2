...
views.get("ctext").vw.setLeft((int)((3d / 100 * width)));
views.get("ctext").vw.setWidth((int)((97d / 100 * width) - ((3d / 100 * width))));
...
views.get("acb1").vw.setWidth((int)((75d / 100 * width) - ((1d / 100 * width))));
views.get("acb1").vw.setHeight((int)((50d * scale)));
views.get("acb1").vw.setTop((int)((views.get("ctext").vw.getTop() + views.get("ctext").vw.getHeight())));
views.get("lv2").vw.setTop((int)((views.get("acb1").vw.getTop() + views.get("acb1").vw.getHeight())+(10d * scale)));
views.get("lv2").vw.setHeight((int)((90d / 100 * height) - ((views.get("acb1").vw.getTop() + views.get("acb1").vw.getHeight())+(10d * scale))));
