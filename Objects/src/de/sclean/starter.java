...
_kvst._deleteall();
 //BA.debugLineNum = 150;BA.debugLine="kvsdata.Put(\"cz\",FormatFileSize(CacheSize))";
_kvsdata._put("cz",(Object)(_formatfilesize((float) (_cachesize))));
 //BA.debugLineNum = 151;BA.debugLine="info_remote";
_info_remote();
 //BA.debugLineNum = 152;BA.debugLine="CallSub(Main,\"dp_clear\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._main.getObject()),"dp_clear");
 //BA.debugLineNum = 153;BA.debugLine="CallSub(info,\"c_ready\")";
...
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._widget.getObject()),"rv_restart");
 //BA.debugLineNum = 131;BA.debugLine="CallSub(Main,\"total_off\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._main.getObject()),"total_off");
 //BA.debugLineNum = 132;BA.debugLine="CallSub(info,\"c_off\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._info.getObject()),"c_off");
 };
