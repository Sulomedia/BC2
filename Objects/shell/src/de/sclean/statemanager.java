...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("de.sclean.statemanager");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("statemanager"), "de.sclean.statemanager");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("de.sclean.statemanager"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static de.sclean.animator _animator = null;
  public Object[] GetGlobals() {
		return new Object[] {"Animator",Debug.moduleToString(de.sclean.animator.class),"info",Debug.moduleToString(de.sclean.info.class),"listPosition",statemanager._listposition,"Main",Debug.moduleToString(de.sclean.main.class),"option",Debug.moduleToString(de.sclean.option.class),"settings",statemanager._settings,"settingsFileName",statemanager._settingsfilename,"Starter",Debug.moduleToString(de.sclean.starter.class),"states",statemanager._states,"statesFileName",statemanager._statesfilename,"supp",Debug.moduleToString(de.sclean.supp.class),"Widget",Debug.moduleToString(de.sclean.widget.class)};
}
}